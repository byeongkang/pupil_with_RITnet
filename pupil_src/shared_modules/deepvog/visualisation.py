...
class VideoManager:
    def __init__(self, vreader, output_record_path="", output_video_path="", heatmap=False, fps=32):
        # Parameters`
        inputdict = {'-r': str(fps)} # FPS 설정
        ...
        self.vwriter = skv.FFmpegWriter(
            output_video_path,
            inputdict=inputdict
        ) if self.output_video_flag else None
    ...
    def write_results(self, frame_id, eyeball_center_x, eyeball_center_y, eyeball_center_z, gaze_normal_x,gaze_normal_y,gaze_normal_z):
        self.results_recorder.write("%d,%f,%f,%f,%f,%f,%f\n" % (frame_id, eyeball_center_x, eyeball_center_y, eyeball_center_z,
                                                                gaze_normal_x, gaze_normal_y,gaze_normal_z))
